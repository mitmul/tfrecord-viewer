...
parser.add_argument("--port", type=int, default=8080, help="Port to start the Flask server.")
parser.add_argument("-v", "--verbose", help="increase output verbosity", action="store_true")
parser.add_argument(
    "--overlay", type=str, default="detection", help="Overlay to display. (detection/classification/segmentation/none)"
)
parser.add_argument(
    "--username",
    type=str,
...
parser.add_argument("--bbox-name-key", type=str, default="image/object/class/text", help="Key to the bbox label.")
...
parser.add_argument("--class-label-key", type=str, default="image/class/text", help="Key to the image class label.")


############################################
# Semantic segmentation specific arguments #
parser.add_argument(
    "--segmap-key", type=str, default="image/segmentation/class/encoded", help="Key to the image segmentation map."
)
...
def preload_images(max_images):
    ...
    print(tfe.enable_eager_execution())
...
def get_image(key):
    ...
    return send_file(img_buffer, attachment_filename=str(key) + ".jpeg", mimetype="image/jpg")
